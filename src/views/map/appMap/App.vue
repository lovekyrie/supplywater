...
<template>
  ...
  >
    ...
    <!-- 人员点 -->
    <bm-marker
      :icon="{url: 'http://www.mypng.cn/thumb/380294?size=32x32', size: {width: 32, height: 32}}"
      v-for="(marker2,i) of userPoints"
      @click="clickHandler2(marker2)"
      :key="i"
    ...
    <bm-control anchor="BMAP_ANCHOR_TOP_RIGHT" :offset="controlSize" v-show="controlShow">
      ...
      <el-row>
        ...
        <el-dialog title="搜索小区" :visible.sync="dialogxq" :center="true" :modal="false" width="45%">
      ...
      <el-row>
        ...
        <el-dialog title="巡检轨迹" :visible.sync="dialogxj" :center="true" :modal="false" width="45%">
          <el-row>
            <el-select v-model="userVal" filterable placeholder="巡检人员" clearable>
              <el-option
                v-for="item in patrolUser"
                :key="item.sysUserPk"
                :label="item.nkNm"
                :value="item.nkNm"
              ></el-option>
    ...
    <bm-info-window :show="infoWindow.show" :position="pointInfo">
      ...
      <el-row :gutter="10">
        <el-col :span="6">
          <img src="./img/视频监控.png" weight="35" height="35">
        </el-col>
        <el-col :span="6">
          <img src="./img/保养管理.png" weight="35" height="35">
        </el-col>
        <el-col :span="6">
          <img src="./img/门禁监控.png" weight="35" height="35">
        </el-col>
        <el-col :span="6">
          <img src="./img/sbda.png" weight="35" height="35" @click="lookDevice(infoWindow.phCd)">
        </el-col>
      </el-row>
      <el-row :gutter="10">
        <el-col :span="6">
          <img src="./img/维修管理.png" @click="lookWX(infoWindow.estateNm)" weight="35" height="35">
        </el-col>
        <el-col :span="6">
          <img src="./img/巡检管理.png" @click="lookXJ(infoWindow.estateNm)" weight="35" height="35">
        </el-col>
      </el-row>
    </bm-info-window>
    <!-- 点击人员点出现的信息框 -->
    ...
    <el-dialog title="泵房设备" :visible.sync="dialogTableVisible" center>
      <el-table :data="gridData" stripe border height="300" size="mini">
        <el-table-column property="deviceNm" label="设备名称" width="160" sortable></el-table-column>
        <el-table-column property="deviceCd" label="设备编号" width="100" sortable></el-table-column>
        <el-table-column property="deviceModel" label="型号规格" width="180" sortable></el-table-column>
      </el-table>
    </el-dialog>
  </baidu-map>
</template>
  ...
  methods: {
    ...
    lookWX(val) {
      ...
      window.location.href =
        "../repair/list.html?search=" + JSON.stringify(search);
    },
    //跳转巡检报表
    lookXJ(val) {
      ...
      window.location.href =
        "../inspection/inspectionReportList.html?search=" +
